...
teamBudget = [16700000, 6500000, 11000000, 15000000, 15000000, 15000000, 8300000, 8000000, 7100000, 14000000, 12800000, 18400000, 8600000, 10400000]  # create initial team budgets, references 'R_tot_it-1'
teamPayroll = [0] * parameters.leagueSize  # create initial team payrolls, references 'sum(W_p * d_p)' in thesis
teamSkill = [0] * parameters.leagueSize  # create initial team skills, references 'S_i' in thesis
teamRevenue = [0] * parameters.leagueSize  # create initial revenue, references 'R_tot_it' in thesis
